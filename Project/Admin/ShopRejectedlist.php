...
if(isset($_GET["aid"]))
{
    ...
    {
		 	header("Location:ShopRejectedlist.php");
	}
	//Email Code Start
...
<table border="1" align="center">
 ...
 <?php
		$selQry="select * from tbl_shop u inner join tbl_place p on u.place_id=p.place_id inner join tbl_district d on        
		 p.district_id=d.district_id where shop_status=2";
 ...
 ?>
 		<tr>
            ...
            <td><a href="ShopRejectedlist.php?aid=<?php echo $data["Shop_id"]?>&user=<?php echo $data["Shop_email"]?>&name=<?php echo $data["shop_name"]?>">Accept</a></td>
