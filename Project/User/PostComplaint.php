...
$insQry="insert into tbl_complaint(complaint_subject,complaint_details,user_id,complaint_date,product_id)values('".$csubject."','".$complaint."','".$_SESSION["userid"]."',curdate(),'".$_GET["cid"]."')";
...
<form id="form1" name="form1" method="post" action="">
 ...
 <center>
  <table width="358" height="287" border="0">
