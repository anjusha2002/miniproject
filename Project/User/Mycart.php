...
<title>MyCart</title>
    ...
    <?php
        ...
        if (isset($_POST["btn_checkout"])) {
                ...
                $selC = "select * from tbl_booking where  user_id='" .$_SESSION["userid"]. "' and booking_status='0'";
                $rs = $conn->query($selC);
                $row=$rs->fetch_assoc();
                ...
                $upQry1 = "update tbl_booking set booking_date=curdate(),booking_amount='".$amt."',booking_status='1' where user_id='" .$_SESSION["userid"]. "'";
...
<body onload="recalculateCart()">
        <h1>Cart</h1>
            <div class="column-labels">
                ...
                <label class="product-price" style="width: 20%; text-align:center">Qty</label>
...
<form method="post">
        <div class="shopping-cart" style="margin-top: 50px"> 
                   <?php                
            $sel = "select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id where b.user_id='" .$_SESSION["userid"]."' and booking_status='0'";
            ...
            <div class="product">
                <div class="product-image">
                    <img
                        src="../Assets/Files/ProductPhoto/<?php echo $rowpr["product_photo"] ?>"
                        />
                </div>
                ...
                <div class="product-price "	><?php echo $rowpr["product_mrp"] ?></div>
