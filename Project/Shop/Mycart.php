...
<form method="post">
        <div class="shopping-cart" style="margin-top: 50px"> 
                   <?php                
            $sel = "select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id where b.shop_id='" .$_SESSION["shopid"]."' and booking_status='0'";
            ...
            <div class="product">
                ...
                <div class="product-price "	><?php echo $rowpr["product_wholesaleprice"] ?></div>
                ...
                <div class="product-line-price">
                    <?php
                        $pr = $rowpr["product_wholesaleprice"];
                        $qty = $row["cart_qty"];
                        $tot = (int)$pr * (int)$qty;
                        echo $tot;
                    ?>
