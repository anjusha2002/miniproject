		  ...
		  <div class="panel-body">
			...
			<div class="row">
				...
				<div class="col-xs-4 to">
					<p class="lead marginbottom">To : <?php echo $data["shop_name"]?></p>
					<p><?php echo $data["shop_address"]?></p>
					
					<p>Phone: <?php echo $data["shop_contact"]?></p>
					<p>Email: <?php echo $data["shop_email"]?></p>
				...
				<table class="table table-striped">
			      ...
			      <tbody>
			        ...
			        <tr>
			          ...
			          <td class="text-right"><?php echo $dats["product_wholesaleprice"]?></td>
			          <td class="text-right"><?php echo $dats["product_wholesaleprice"] *$dats["cart_qty"]?></td>
