...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2022 at 02:56 PM
...
INSERT INTO `tbl_booking` (`booking_id`, `user_id`, `booking_status`, `shop_id`, `booking_date`, `booking_amount`) VALUES
(2, 29, 1, 0, '2022-11-04', 1340);
...
(15, 'Grape5ltr', 'Exp Date:29/10/2024', 720, 710, 'download (1).jpg', 4, 10, 38),
(16, 'Guava5ltr', 'Exp Date:1/11/2023', 720, 710, '750-1-pink-guava-malanad-original-imagaecuzjdkaymq.webp', 3, 10, 50),
...
(10, 'Regency Bake House', 'A M Road,kothamangalam P OErnakulam,Kerala 686691', 'regency@1', '7593094608', 'regency1', 'edakkattukudiyil-regency-bake-house-ernakulam-bo0xzwr66w.webp', 'regency-bake-house-muvattupuzha-map.jpg', 1, 28),
...
(29, 'Ajay Saju', 'male', '8075508529', 'ajay2003@gmail.com', 'ajay', 'ajay21', 'kottakkara', 1, 28, 'download (3).jpg'),
...
--
ALTER TABLE `tbl_usercart`
  MODIFY `usercart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
COMMIT;
