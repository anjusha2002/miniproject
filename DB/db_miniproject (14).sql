...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2022 at 02:20 PM
...
(1, 'Malanad Plantation', 'malanad@gmail.com', 'Malanad_@1');
...
(65, 40, 1, 0, '2022-11-11', 2160, 0),
(66, 40, 1, 0, '2022-11-11', 2160, 1),
(67, 40, 1, 0, '2022-11-11', 2160, 0),
(68, 40, 1, 0, '2022-11-11', 2160, 1),
(69, 40, 2, 0, '2022-11-11', 2160, 1),
(70, 0, 1, 10, '2022-11-11', 155, 0),
(71, 0, 1, 10, '2022-11-11', 155, 1),
(72, 0, 1, 10, '2022-11-11', 155, 1),
(73, 0, 1, 10, '2022-11-11', 155, 1),
(74, 0, 2, 10, '2022-11-11', 155, 1);
...
(9, '2022-11-11', 'Mango', 'not clean', 0, '', '2022-11-11', 0, 10, 22),
(10, '2022-11-11', 'Pinapple', 'mjhgfdxfcghjkjhgfvc', 0, '', '2022-11-11', 40, 0, 0);
...
(20, 'Passion Fruit', 'For the seasons where the fruits are not available, enjoy the sweet and delicious passion fruit squash.', 270, 265, 'image-3 (1).jpeg', 6, 8, 50),
(21, 'Passion Fruit', 'For the seasons where the fruits are not available, enjoy the sweet and delicious passion fruit squash.', 215, 210, 'image-3 (1).jpeg', 6, 7, 49),
(22, 'Passion Fruit', 'For the seasons where the fruits are not available, enjoy the sweet and delicious passion fruit squash.', 160, 155, 'image-3 (1).jpeg', 6, 6, 47),
(23, 'Passion Fruit', 'For the seasons where the fruits are not available, enjoy the sweet and delicious passion fruit squash.', 1300, 1295, 'image-3 (1).jpeg', 6, 10, 50),
(24, 'Mango', 'The authentic mango king of all fruits, bottled into golden yellow mango crush is the perfect choice to enjoy the fun of summer.', 220, 215, 'image-1 (2).jpeg', 1, 9, 50),
(25, 'Mango', 'The authentic mango king of all fruits, bottled into golden yellow mango crush is the perfect choice to enjoy the fun of summer.', 720, 715, 'image-1 (2).jpeg', 1, 10, 50),
(26, 'Pineapple', 'The pineapple tartness bottled as crushes gives your taste buds a sweet and tangy experience, by bringing the authentic tropical flavour to your table', 720, 715, 'image-2 (2).jpeg', 2, 10, 50),
(27, 'Grape', 'Refreshing and delicious Grape Crush to enjoy on the sunny days, with real grape balls for that extra flavour!', 720, 715, 'image1.jpeg', 4, 10, 48),
(28, 'Guava', 'Enjoy the pink creamy texture of guava with its nutritional benefits of vitamins, potassium, lycopene, proteins, and fibre with our very delicious Gua', 720, 715, 'image-1 (1).jpeg', 3, 10, 47),
(29, 'Nannari', 'Keep yourself hydrated with the natural coolant and blood purifier bottled as our very own Nannari Sarbath.', 725, 720, 'image-1 (3).jpeg', 5, 7, 44),
(30, 'Strawberry', 'Treat your taste buds to the ravishingly red & sweet fruit flavour of STRAWBERRY!!!', 300, 295, 'Strawberry.jpeg', 7, 7, 44);
...
(43, 'Anna Sara Shine', 'female', '9778219810', 'annasarashine2002@gmail.com', 'annasara', 'Annasara_@1', 'Panackal(H)\r\nKaninadu p.o', 0, 29, '1f8f353e-7cd7-480d-af86-dc3e6182011e.jpg'),
(44, 'Anna Sara Shine', 'female', '9778219810', 'annasarashine2002@gmail.com', 'annasara', 'Annasara_@1', 'Panackal(H)\r\nKaninadu p.o', 2, 29, '1f8f353e-7cd7-480d-af86-dc3e6182011e.jpg');
